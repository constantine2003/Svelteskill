...
<nav class="fixed top-0 left-0 right-0 z-50 h-14 flex items-center px-8 gap-8 bg-[#1c1c1c]/90 backdrop-blur-sm border-b border-white/10">
  ...
  <!-- Logo -->
  <a rel="external" href="/" class="flex items-center gap-2.5 mr-4">
  ...
  <div class="flex items-center gap-1 flex-1">
    <a rel="external" href="/tracks" class="text-[#f0ede8]/50 hover:text-[#f0ede8] text-sm px-3 py-1.5 rounded-md hover:bg-white/5 transition-all">Tracks</a>
    <a rel="external" href="/#how" class="text-[#f0ede8]/50 hover:text-[#f0ede8] text-sm px-3 py-1.5 rounded-md hover:bg-white/5 transition-all">How it works</a>
    <a rel="external" href="/#cert" class="text-[#f0ede8]/50 hover:text-[#f0ede8] text-sm px-3 py-1.5 rounded-md hover:bg-white/5 transition-all">Certificates</a>
  </div>
  ...
  <div class="flex items-center gap-3 ml-auto">
    ...
    {:else}
      <!-- Logged out -->
      <a rel="external" href="/auth" class="text-[#f0ede8]/50 hover:text-[#f0ede8] text-sm px-3 py-1.5 rounded-md hover:bg-white/5 transition-all">
        Log in
      </a>
      <a rel="external" href="/auth" class="text-sm font-semibold text-white bg-[#FF3E00] hover:brightness-110 px-4 py-1.5 rounded-lg transition-all">
        Get started
      </a>
    {/if}
  </div>
