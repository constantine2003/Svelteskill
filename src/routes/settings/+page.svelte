...
<div class="min-h-screen bg-[#1a1a1a]">
  <main class="max-w-[640px] mx-auto px-8 py-14">

    <!-- Header -->
    <div class="mb-12">
      <a rel="external" href="/dashboard"
        class="inline-flex items-center gap-2 text-[#f0ede8]/30 hover:text-[#f0ede8]/60 font-mono text-[11px] tracking-wide transition-colors mb-8">
    ...
    <!-- Avatar -->
    <div class="flex items-center gap-5 mb-12 pb-12 border-b border-white/8">
    ...
    <!-- Danger zone -->
    <div class="mt-16 pt-10 border-t border-white/8">
